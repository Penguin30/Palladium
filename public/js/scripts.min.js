	...
	*/
	...
	$hall_seats.on('click', function(event) {
        ...
        $container_adding_tickets.find('.buy-price-info').removeClass('d-none');
				...
				$('.chosen-seats.seats-filled .seat-row-gought[id='+$currentPlace+'] a.delete').on('click', function() {
          $('.price-final .uan').text( +$('.price-final .uan').text() - +$(this).closest('.seat-row-gought').find('.price').text());
          $('.hall-seats [data-place='+$(this).closest('.seat-row-gought').attr('id')+']').removeClass('chosen');
          $('.hall-seats [data-place='+$(this).closest('.seat-row-gought').attr('id')+'] span').remove();
          ...
          $('.chosen-seats.seats-filled .seat-row-gought[id='+$currentPlace+'] a.delete').off('click');
